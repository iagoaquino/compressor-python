...
def get_mesure(file):
    ...
    return width_image,height_image, block_width, block_height

def reconstruct_queue(block_width, block_height):
    queue_main = []
...
width, height, block_width, block_height  = get_mesure(file)
trees = []
queue_main = reconstruct_queue(block_width, block_height)
